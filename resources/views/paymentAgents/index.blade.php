...
<div   role="main">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Manage Payment Agents</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST" action="{{ route('paymentAgents.store') }}"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input id="passport_no" class="form-control" value="{{ old('passport_no') }}"
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="table">
                                ...
                                <tbody>
                                    @foreach($paymentAgents as $paymentAgent)
                                        <tr>
                                            <td>{{ $paymentAgent->name }}</td>
                                            <td>{{ $paymentAgent->location }}</td>
                                            <td>{{ $paymentAgent->primary_phone }}</td>
                                            <td>{{ $paymentAgent->secondary_phone }}</td>
                                            <td>{{ $paymentAgent->primary_email }}</td>
                                            <td>{{ $paymentAgent->secondary_email }}</td>
                                            <td>{{ $paymentAgent->cnic }}</td>
                                            <td>
                                                <a href="{{ route('paymentAgents.edit', $paymentAgent->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('paymentAgents.destroy', $paymentAgent->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
