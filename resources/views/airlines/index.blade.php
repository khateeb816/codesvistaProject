...
<div class="right_col" role="main">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST" action="{{ route('airlines.store') }}"
                                ...
                                <tbody>
                                    @foreach($airlines as $airline)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('airlines.edit', $airline->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('airlines.destroy', $airline->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this airline?')">
