...
<div class="right_col" role="main">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Manage Education Categories</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form class="form-horizontal form-label-left" method="POST" action="{{ route('educationCategories.store') }}"
            ...
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title d-flex justify-content-between">
                        <h2>Education Category Listing</h2>
                    </div>
                    <div class="x_content">
                        @if(session('success'))
                            ...
                            <table class="table table-striped table-bordered" id="table">
                                ...
                                <tbody>
                                    @foreach($educationCategories as $educationCategory)
                                        <tr>
                                            <td>{{ $educationCategory->name }}</td>
                                            <td>
                                                <a href="{{ route('educationCategories.edit', $educationCategory->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('educationCategories.destroy', $educationCategory->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this education category?')">
